        ...
        return (
            <div className="min-h-screen bg-white">
                ...
                <div className="max-w-4xl mx-auto px-6 py-24 text-center">
                    ...
                    <Link to="/blog" className="text-green-600 font-bold">Back to blog</Link>
                </div>
                <Footer />
            </div>
        );
            ...
            <section className="pt-24 pb-16">
                <div className="max-w-4xl mx-auto px-6 md:px-12">
                    <FadeIn direction="up">
                        ...
                        <div className="mb-4">
                            <span className="px-3 py-1 rounded-full text-[12px] font-black bg-green-100 text-green-700">{post.category}</span>
                        </div>
